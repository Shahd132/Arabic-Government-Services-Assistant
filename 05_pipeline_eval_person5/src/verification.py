...
class VerificationResult:
    is_supported: bool  # True ONLY for a clean "SUPPORTED" verdict.
    # PARTIALLY_SUPPORTED still contains at least one unsupported claim, so
    # it is NOT counted as supported here -- graph.py's is_verified UI flag
    # and its regeneration/disclaimer logic both depend on this being strict.
    verdict: str
    explanation: str
